...
@Test
public class givexproduct {
	public void GivexProduct() throws InterruptedException
	{
		...
		//GIVEX GIFT CARD SELECTION
		Select dropdowngivex = new Select(Configurations.driver.findElement(By.name("digital_service_provider")));
		dropdowngivex.selectByValue("givex"); //Givex
		Thread.sleep(2000);
		
		//DELIVERY MODE
		Select dropdowndeliverygivex = new Select(Configurations.driver.findElement(By.cssSelector("select[name='delivery_mode']")));
		Thread.sleep(2000);
		dropdowndeliverygivex.selectByValue("givex_both");    //GIVEX BOTH
		Thread.sleep(2000);
		dropdowndeliverygivex.selectByValue("givex_digital"); //GIVEX DIGITAL
		Thread.sleep(2000);
		//dropdowndeliverygivex.selectByValue("givex_physical"); //GIVEX PHYSICAL
		//Thread.sleep(2000);
